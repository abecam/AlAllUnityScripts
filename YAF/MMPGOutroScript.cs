...
public class MMPGOutroScript : MonoBehaviour
{
    ...
    private const int NB_OF_ELEMENTS = 4;

    private const int NB_OF_CUBE_X = 2;
    private const int NB_OF_CUBE_Y = 2;
    ...
    void Start()
    {
        ...
        for (int iBrotherX = 0; iBrotherX < NB_OF_CUBE_X; iBrotherX++)
        {
            for (int iBrotherY = 0; iBrotherY < NB_OF_CUBE_Y; iBrotherY++)
            {
                ...
                allBacks[iBrother2].transform.localScale = new Vector3(2f, 2f, 02f);

                float floatX = ((float)iBrotherX - HALF_NB_OF_CUBE_X)/10;
                float floatY = ((float)iBrotherY - HALF_NB_OF_CUBE_Y)/10;

                allBacks[iBrother2].transform.localPosition = new Vector3(floatX*16, floatY*16, 5);
    ...
    private void completeStrings()
    {
        ...
        timeSpentTxt = "You finished the mode in\n" + ((hoursSpentMode > 0) ? hoursSpentMode + " hours\n" : "") +
        ...
        else
        {
            ...
            timeSpentTxt += "\nBest time is\n" + ((hoursBestSpentMode > 0) ? hoursBestSpentMode + " hours " : "") +
