...
public class ZoomAndScrollTitle : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (currentTime > timeBeforeMove)
        {
            ...
            else
            {
                ...
                transform.localPosition = new Vector3(transform.localPosition.x, transform.localPosition.y + newPan, transform.localPosition.z);
