...
public class QuitFindingNyafings : MonoBehaviour
{
    private ManageFindingNyafings mainGameScript; // To pause gameplay
    ...
    void Start()
    {
        ...
        mainGameScript = mainCamera.GetComponent<ManageFindingNyafings>();
    ...
    void Update()
    {
        if (coolDown == 0 && Keyboard.current.escapeKey.wasReleasedThisFrame)
        {
