...
public class QuitMovingNyaf : MonoBehaviour
{
    private ManageMovingNyaf mainGameScript; // To pause gameplay
    ...
    void Start()
    {
        ...
        mainGameScript = mainCamera.GetComponent<ManageMovingNyaf>();
