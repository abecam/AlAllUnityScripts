...
public class PlaceCharsToFind : MonoBehaviour
{
    ...
    private void PlaceBombsAndTraps()
    {
        ...
        for (int iBlackBomb = 0; iBlackBomb < nbBlackBombs; iBlackBomb++)
        {
            ...
            z = Random.value * 8;
            {
                ...
                if (success)
                {
                    PlaceCharacters.applyFunction(radius, 0, z, out xCurr, out yCurr, out zOut, currentLevel);
                    PlaceCharacters.applyFunction(radius + 0.04f * Mathf.PI, 0, z, out xNext, out yNext, out zOut, currentLevel);
                    ...
                    {
                        newPenalty = Instantiate(bombsNoir, new Vector3(xCurr, yCurr, -4 + zOut), direction, parentBlackBombs);
                        ...
                        if (isUnderground)
                        {
                            newPenalty.GetComponent<Renderer>().material.color = new Color(0.8f + Random.value * 0.2f, 0.8f + Random.value * 0.2f, 0.5f + Random.value * 0.2f, newPenalty.GetComponent<Renderer>().material.color.a);
                        }
                        else if (isUnderwater)
                        {
                            newPenalty.GetComponent<Renderer>().material.color = new Color(0.4f + Random.value * 0.2f, 0.4f + Random.value * 0.2f, 0.8f + Random.value * 0.2f, newPenalty.GetComponent<Renderer>().material.color.a);
                            newPenalty.AddComponent<MoveInWater>();
                            newPenalty.GetComponent<MoveInWater>().setInitialPos();
                        }
                    }
                }
            }
        ...
        for (int iBlackBomb = 0; iBlackBomb < nbRedBombs; iBlackBomb++)
        {
            ...
            z = Random.value * 8;
            {
                ...
                if (success)
                {
                    ...
                    {
                        newPenalty = Instantiate(bombsRouge, new Vector3(xCurr, yCurr, -4 + zOut), direction, parentRedBombs);
        ...
        for (int iTraps = 0; iTraps < nbTraps; iTraps++)
        {
            ...
            z = Random.value * 8;
            {
                ...
                if (success)
                {
                    ...
                    newPenalty = Instantiate(allTraps[whichChar], new Vector3(xCurr, yCurr, -4 + zOut), direction, parentTraps);
        ...
        foreach (Transform oneCharToFind in charactersToFind.transform)
        {
            //float amplitude = AmplitudeFunction(z);
            {
...

                {
                    ...
                    oneCharToFind.localPosition = new Vector3(xCurr, yCurr, -4 + z);
                    ...
                    if (pieceTransparences)
                    {
                        oneCharToFind.GetComponent<Renderer>().material.color = new Color(colorTo.r, colorTo.g, colorTo.b, 0.9f);
                    }
                    if (isUnderground)
                    {
                        oneCharToFind.GetComponent<Renderer>().material.color = new Color(0.8f + Random.value * 0.2f, 0.8f + Random.value * 0.2f, 0.5f + Random.value * 0.2f, oneCharToFind.GetComponent<Renderer>().material.color.a);
                    }
                    else if (isUnderwater)
                    {
                        ...
                        oneCharToFind.gameObject.GetComponent<MoveInWater>().setInitialPos();
                    }
